...
<div class="container"> 
    ...
    <div class="select" >
      <div>
        <button class="btn btn-light btn-sm" on:click={allSelect} >선택</button>
        <button class="btn btn-light btn-sm" on:click={allUnselect} >해제</button>
      </div>
      <div class="etc-form">
    ...
    <div class="row-check">
      ...
      <div class="col radio-b">
        <button class="btn btn-light btn-sm" on:click={() => {video.masturbation = none
                                              video.massage = none
                                              video.uniform = none
                                              video.family = none}}>
          C</button>
